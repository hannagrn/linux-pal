...
Unattended install -välilehdellä määritin salasanan ja käyttäjänimen. Hardware- ja Hard Disk -välilehdillä määrittelin käytössä olevan muistin (4096 MB), prosessorien määrän (2) ja kovalevyn (60 GB). Alla vielä kuva Virtual Boxista, jossa näkyy määrittelyjä asennuksen jälkeisessä näkymässä.
